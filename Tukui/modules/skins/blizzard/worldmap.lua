...
local function LoadSkin()
	...
	WorldMapFrameSizeDownButton.text = T.SetFontString(WorldMapFrameSizeDownButton, C.media.font, 14, "MONOCHROME")
	WorldMapFrameSizeDownButton.text:SetPoint("CENTER")
	WorldMapFrameSizeDownButton.text:SetText("_")
	...
	WorldMapFrameSizeUpButton.text = T.SetFontString(WorldMapFrameSizeUpButton, C.media.font, 14, "MONOCHROME")
	WorldMapFrameSizeUpButton.text:SetPoint("CENTER")
