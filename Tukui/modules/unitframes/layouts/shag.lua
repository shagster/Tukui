...
if C.unitframes.showpettarget then
	...
	pettarget:SetPoint("TOPLEFT", tot, "BOTTOMLEFT", 0, -3)
	pettarget:Size(T.Pettarget, pettarget.Health:GetHeight() + pettarget.Power:GetHeight() + pettarget.panel:GetHeight() + 6)
end
