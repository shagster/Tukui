...
TukuiMinimap:Point("TOPRIGHT", UIParent, "TOPRIGHT", -41, -10)
...
m_zone_text:SetFont(C["media"].pixelfont, 10, "MONOCHROMEOUTLINE")
...
m_coord_text:SetFont(C["media"].pixelfont, 10, "MONOCHROMEOUTLINE")
