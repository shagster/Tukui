...
if C["datatext"].fps_ms and C["datatext"].fps_ms > 0 then
	...
	Stat:SetScript("OnEnter", function(self)
		if not InCombatLockdown() then
			...
			--GameTooltip:AddDoubleLine("Total latency", ms_combined .. " " .. MILLISECONDS_ABBR, 1, 1, 1, 1, 1, 1)
			GameTooltip:AddDoubleLine("Home latency", ms_home .. " " .. MILLISECONDS_ABBR, 1, 1, 1, 1, 1, 1)
			GameTooltip:AddDoubleLine("World latency", ms_world .. " " .. MILLISECONDS_ABBR, 1, 1, 1, 1, 1, 1)
			GameTooltip:AddLine(" ")
