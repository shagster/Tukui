	...
	for _, i in ipairs(bs) do
		...
		if bag_cnt > 0 then
			...
			for j = 1, bag_cnt do
				...
				b.frame:ClearAllPoints()
				b.frame:SetPoint("TOPLEFT", sf, "TOPLEFT", xoff, yoff)
				b.frame:Height(29)
				b.frame:Width(29)
...
function Stuffing:PLAYER_ENTERING_WORLD()
	...
	ContainerFrame1:HookScript("OnShow", function(self)
		...
		keybackdrop:SetPoint("TOPLEFT", 9, -40)
		...
		for i=1, GetKeyRingSize() do
			...
			t:SetPoint("TOPLEFT", slot, 2, -2)
			t:SetPoint("BOTTOMRIGHT", slot, -2, 2)
	...
	ContainerFrame1:SetPoint("BOTTOMRIGHT", TukuiInfoRight, "TOPRIGHT", 4, 3)
