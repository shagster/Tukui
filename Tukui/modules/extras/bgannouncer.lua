...
button1:CreatePanel("Hydra", (TukuiInfoRight:GetWidth()-12)/6, TukuiInfoRight:GetHeight(), "BOTTOMLEFT", buttonframe, "BOTTOMLEFT", 0,0)
...
button2:CreatePanel("Hydra", (TukuiInfoRight:GetWidth()-12)/6, TukuiInfoRight:GetHeight(), "LEFT", button1, "RIGHT", 2,0)
...
button2_text:SetFont(C.media.pixelfont, C["datatext"].fontsize, "THINOUTLINE")
...
button3:CreatePanel("Hydra", (TukuiInfoRight:GetWidth()-12)/6, TukuiInfoRight:GetHeight(),"LEFT", button2, "RIGHT", 2,0)
...
button4:CreatePanel("Hydra", (TukuiInfoRight:GetWidth()-12)/6, TukuiInfoRight:GetHeight(), "LEFT", button3, "RIGHT", 2,0)
...
button5:CreatePanel("Hydra", (TukuiInfoRight:GetWidth()-12)/6, TukuiInfoRight:GetHeight(), "LEFT", button4, "RIGHT", 2,0)
...
button5_text:SetFont(C.media.pixelfont, C["datatext"].fontsize, "THINOUTLINE")
...
button6:CreatePanel("Hydra", (TukuiInfoRight:GetWidth()-12)/6, TukuiInfoRight:GetHeight(), "LEFT", button5, "RIGHT", 2,0)
...
local button5_text = button6:CreateFontString(nil,"Overlay")
button5_text:SetFont(C.media.pixelfont, C["datatext"].fontsize, "THINOUTLINE")
button5_text:Point("Center",1,1)
button5_text:SetText(T.panelcolor.."Hidden")
