...
loadf:Size(C.im.acpwidth, C.im.acpheight)
loadf:SetPoint("CENTER")
--loadf:SetPoint("CENTER", UIParent, "CENTER", 0, 0)
...
local raid_addons = CreateFrame("Button", "TukuiEnableRaidButton", aLoadFrame, "SecureActionButtonTemplate")
