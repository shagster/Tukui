...
local function chatsetup()
	-- setting chat frames if using Tukui chats.					
		...
		FCF_OpenNewWindow(L.chat_messages)
	...
	for i = 1, NUM_CHAT_WINDOWS do
		...
		if i == 1 then
			...
			frame:Point("BOTTOMLEFT", TukuiChatBackgroundLeft, "TOPLEFT", 0, 6)
		elseif i == 5 and chatName == LOOT then
			frame:ClearAllPoints()
			frame:Point("BOTTOMRIGHT", TukuiChatBackgroundRight, "TOPRIGHT", 0, 6)
		end
	...
	ChatFrame_AddMessageGroup(ChatFrame1, "gcrpewpew")
