...
TukuiL.option_general_multisample = "Multisampling protection (cleaner borders)"
...
TukuiL.option_general_skinblizz = "Reskin Blizzard frames to match Tukui"
 
-- nameplate
TukuiL.option_nameplates = "Nameplates"
TukuiL.option_nameplates_enable = "Enable Nameplates"
TukuiL.option_nameplates_track_auras = "Track your auras on nameplates"
...
TukuiL.option_im_acpheight = "Set height of addon control panel window"
TukuiL.option_im_acpwidth = "Set width of addon control panel window"
...
TukuiL.option_merchant_guildrepair = "Automatically use guild funds to repair"
...
-- scombo
TukuiL.option_sCombo = "sCombo"
TukuiL.option_sCombo_enable = "Enable sCombo (combo points)"
TukuiL.option_sCombo_energybar = "Enable the energybar under sCombo bar"
...
TukuiL.option_datatext_specswitcher = "Specswitcher"
TukuiL.option_datatext_classcolor = "Enable classcolor for datatext value text"
TukuiL.option_datatext_color = "Color of datatext values if classcolored is disabled"
TukuiL.option_datatext_classpanel = "Enable classcolor for other panel text"
TukuiL.option_datatext_statcolor = "Color of other panels if classcolored is disabled"
TukuiL.option_datatext_bgannouncer = "Enable BG Announcer panel on Info Right"
TukuiL.datatext_specswitcher = "Show current spec and allows mouse-click spec change. Set to 1 for best results."
...
TukuiL.option_unitframes_aurawatch = "Enable PVE raid Aura Watch"
...
TukuiL.option_unitframes_portrait = "Enable portraits on Player/Target frames"
TukuiL.option_unitframes_classicon = "Show class icons on Player/Target frames"
TukuiL.option_unitframes_enable = "Enable Tukui Unit Frames"
TukuiL.option_unitframes_enemypower = "Enable Power display on PvP targets only"
...
TukuiL.option_unitframes_focus = "Enable Focus target frame"
...
TukuiL.option_unitframes_unicolor = "Enable Unicolor theme (grey health bar)"
...
TukuiL.option_unitframes_showfocustarget = "Show focus target"
TukuiL.option_unitframes_showsolo = "Show raid frames when solo (DPS only)"
TukuiL.option_unitframes_extendedpet = "Extended pet frame"
TukuiL.option_unitframes_bordercolor = "Set default border color of panels"
TukuiL.option_unitframes_style = "Choose unit layout Shag or Smelly"
TukuiL.option_unitframes_bigfocuscast = "Large focus castbar - Show the focus castbar in center of UI and large scale"
TukuiL.option_unitframes_showfocustarcast = "Show the focus target's castbar"
TukuiL.option_unitframes_unicolorgradient = "Enable gradient on Player/Target with unicolor mode"
TukuiL.option_unitframes_gradienthealth = "Change raid health color based on health percent"
TukuiL.option_unitframes_gradient = "RGB of raid gradient when enabled"
TukuiL.option_unitframes_pettarget = "Show your pet's target frame"

--castbar
TukuiL.option_castbar = "Castbar"
TukuiL.option_castbar_classcolor = "Make the castbar class colored"
TukuiL.option_castbar_castbarcolor = "Color of castbar if it can be interrupted"
TukuiL.option_castbar_nointerruptcolor = "Color of castbar if it canNOT be interrupted"
...
TukuiL.option_map_location_panel = "Enable Location panel"
...
TukuiL.option_actionbar_mainbarwidth = "Amount of buttons per row on main bar (set between 1-12)"
TukuiL.option_actionbar_sidebarwidth = "Amount of buttons per row on side bars (set between 0-6, 0 = disabled)"
...
-- extra panels
TukuiL.option_extra_panels = "Extra Panels"
TukuiL.option_extra_panels_bottompanel = "Viewport panel on bottom"
TukuiL.option_extra_panels_toppanel = "Viewport panel on top"
TukuiL.option_extra_panels_threatbar = "Enable the threatbar, next to chat left"
